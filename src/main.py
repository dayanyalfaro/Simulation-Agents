...
environments = [Simulation(width=10, height=10, dirtiness=25, obstacles=15, children=5, interval=10, id = 1),
                Simulation(width=7, height=8, dirtiness=15, obstacles=10, children=3, interval=5, id = 2),
                Simulation(width=7, height=8, dirtiness=15, obstacles=10, children=3, interval=20, id = 3),
                Simulation(width=15, height=15, dirtiness=15, obstacles=15, children=10, interval=50, id = 4),
                Simulation(width=5, height=5, dirtiness=10, obstacles=5, children=2, interval=5, id = 5),
                Simulation(width=10, height=5, dirtiness=20, obstacles=20, children=3, interval=10, id = 6),
                Simulation(width=10, height=10, dirtiness=30, obstacles=10, children=5, interval=20, id = 7),
                Simulation(width=10, height=10, dirtiness=10, obstacles=30, children=5, interval=30, id = 8),
                Simulation(width=9, height=9, dirtiness=15, obstacles=20, children=3, interval=20, id = 9),
                Simulation(width=10, height=10, dirtiness=20, obstacles=20, children=4, interval=20, id=10)
                ]
